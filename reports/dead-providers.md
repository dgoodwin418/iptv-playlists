...
|---:|---|---|
| 80 | `khala.skylivehd` | Server for live sporting events. |
| 78 | `streams2.sofast.tv` | Server for live sporting events. |
| 58 | `193.47.62.44` | Live sports server |
| 52 | `193.47.62.41` | 403 and does not play in Kodi. Server for live sporting events |
| 51 | `dai2.xumo` | none of the channels played in VLC |
| 49 | `technologycloud.eu:80` | none of the channels played in VLC |
| 34 | `chatgpt.hereisman.net` | Live sports server |
...
| 26 | `edgestream1.pro` | Live sports STRMCNTR no links working |
| 22 | `edgestream2.pro` | Live sports STRMCNTR no links working |
| 20 | `a.jsrdn` | None of the channels played in VLC |
| 17 | `77.137.40.221:8000` | no channels played in VLC |
| 16 | `edgestream3.pro` | Live sports STRMCNTR no links working |
...
| 10 | `node-8bba18be.4587.website` | No channels work in VLC |
| 10 | `wp.streamtp.sbs:443` | No channels played in VLC |
