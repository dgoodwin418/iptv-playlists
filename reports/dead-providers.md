...
| 30 | `193.47.62.44` | Live sports server |
| 29 | `169.150.223.25` | None of the channels played in VLC |
| 26 | `khala.skylivehd` | Server for live sporting events. |
...
| 12 | `edgestream1.pro` | Live sports STRMCNTR no links working |
| 12 | `edgestream2.pro` | Live sports STRMCNTR no links working |
| 12 | `pw.streamtp.sbs:443` | Live Sports Server |
...
| 6 | `edgestream3.pro` | Live sports STRMCNTR no links working |
| 4 | `wp.streamtp.sbs:443` | No channels played in VLC |
| 2 | `chatgpt.hereisman.net` | Live sports server |
